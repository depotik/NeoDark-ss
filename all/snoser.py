...
def center_text(text, width=80):
    ...
    centered_lines = []
    for line in lines:
        # Убираем ANSI коды для подсчета реальной длины строки
...
╚═╝  ╚═══╝╚══════╝ ╚═════╝ ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝
{color_code['reset']}
{color_code['yellow']}Creator: @weeaave
Special for NeoDark{color_code['reset']}
...
║                                                ║
║ [5] Проверить почту    [6] Создать почту       ║
║       (soon)                   (soon)          ║
║                                                ║
...
# Для использования просто напечатайте баннер
print(banner)
